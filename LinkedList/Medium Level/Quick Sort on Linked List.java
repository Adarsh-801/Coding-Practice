...
class GfG
{
    ...
    public static Node quickSort(Node node)
    {
        ...
        Node tmp = part.next; //making the head of 2nd part of LL
        
        part.next = null; //breaking the Link
        
        quickSort(node); //called quicksort on first part
        quickSort(tmp);  //called quicksort on second part
        part.next = tmp; //recreating the link
