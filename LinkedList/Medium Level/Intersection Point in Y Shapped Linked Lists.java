...
EXPLANATION LINK - https://www.youtube.com/watch?v=8CACsqPWpHo
...
class Intersect
{
	...
	int intersectPoint(Node head1, Node head2)
	{
         ...
         int ans = 0;
         int diff = 0;
         Node temp1;  //will iterate on the lnoger LL
         Node temp2; //will iterate on the shorter LL
         
         //if the first LL is bigger
         if(len1 > len2){
             diff = len1-len2;
             temp1 = head1;     //assigning the temp1 and temp2 accordingly
             temp2 = head2;
         }
         else{
             diff = len2-len1;
         ...
         //bringing both temp1 and temp2 in same level
         while(diff != 0){
              temp1 = temp1.next;
              if(temp1 == null){  //no intersection case
                  return -1;
              }
              diff--;
         }
